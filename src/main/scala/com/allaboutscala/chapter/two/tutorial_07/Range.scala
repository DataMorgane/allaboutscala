...
object Range extends App {
  ...
  println(s"Range of alphabet from a to z = $alphabetRangeFromAToZ")
  ...
  println(s"${alphabetRangeFromAToZBy2.toList.mkString(" ")}")
  val setFrom1To5 = (1 to 5).toSet
  println(s"Range to set = ${setFrom1To5.mkString(" ")}")
  val sequenceFrom1To5 = 1 to 5  // equivalent to (1 to 5).toSeq
